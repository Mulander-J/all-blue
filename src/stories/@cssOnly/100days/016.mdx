...
# `#16` [Blobby](https://100dayscss.com/days/16/)

Blobby: It appears, wobbles, changes its shape and disappears again. Just like that.

## CodePen

> See the Pen [#16 CSS Challenge / Blobby](https://codepen.io/mulander/pen/ExGaZpZ)
...
<iframe
  ...
  scrolling="no"
  title="#16 CSS Challenge / Blobby"
  src="https://codepen.io/mulander/embed/ExGaZpZ?default-tab=html%2Cresult"
  frameBorder="no"
  loading="lazy"
