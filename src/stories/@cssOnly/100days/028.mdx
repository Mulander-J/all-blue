...
# `#28` [Ring Ring](https://100dayscss.com/days/28/)
...
> See the Pen [#28 CSS Challenge / Ring Ring](https://codepen.io/mulander/pen/rNoxmPv)
...
<iframe
  ...
  scrolling="no"
  title="#28 CSS Challenge / Ring Ring"
  src="https://codepen.io/mulander/embed/rNoxmPv?default-tab=html%2Cresult"
  frameBorder="no"
  loading="lazy"
