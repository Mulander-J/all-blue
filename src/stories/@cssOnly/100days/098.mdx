...
# `#98` [Plopp](https://100dayscss.com/days/98/)

Plopp: What do you want to fill your box with?

## CodePen

> See the Pen [#98 CSS Challenge / Plopp](https://codepen.io/mulander/pen/KKbXeBM)
...
<iframe
  ...
  scrolling="no"
  title="#98 CSS Challenge / Plopp"
  src="https://codepen.io/mulander/embed/KKbXeBM?default-tab=html%2Cresult"
  frameBorder="no"
  loading="lazy"
