...
<Meta title="@SVG/SplitFont" />

# SplitFont
> Reference: [【每天学一点CSS】快看，CSS 让这个文字动起来了~](https://www.bilibili.com/video/BV16p4y117k1)

export const FontSvg =  ()=><svg viewBox="0 0 1000 300">
    <symbol id="line-text">
    <text textAnchor="middle" x="50%" y="50%" dy=".4em">
        Microgoople
    </text>
    </symbol>
    <use xlinkHref="#line-text" className="text"></use>
    <use xlinkHref="#line-text" className="text"></use>
    <use xlinkHref="#line-text" className="text"></use>
    <use xlinkHref="#line-text" className="text"></use>
</svg>

<div className="Wrap_SplitFont">
    <FontSvg />
</div>
