<script>
   ...
   */
  export let main = "#bf2a2a";

  /**
   * @type {color} Side Color
   */
  export let side = "#ede9e8";

  /**
   * @type {color} Cam Color
   */
  export let cam = "#ede9e8";
  /**
   * @type {color} CamRing Color
   */
  export let camRing = "#bf2a2a";
  /**
   * @type {color} Logo Color
   */
  export let logo = "#ede9e8";
  /**
   * @type {number} Animate Speed
   */
  export let animateSpeed = 12;
  ...
  <div class="iphone-device">
    ...
    <div class="iphone-back">
      <div class="iphone-cam-group">
        <div class="iphone-ba-cam1" />
        <div class="iphone-ba-cam2" />
        <div class="iphone-ba-light" />
        <div class="iphone-ba-spot" />
      </div>
    ...
    <!-- 后-背板 -->
    <div class="iphone-back-s" />
    <!-- 侧边-左 -->
    <div class="iphone-left iphone-side" />
    <!-- 侧边-右 -->
    <div class="iphone-right iphone-side" />
    <!-- 侧边-上 -->
    <div class="iphone-top iphone-side" />
    <!-- 侧边-下 -->
    <div class="iphone-bottom iphone-side" />
  </div>
</div>
